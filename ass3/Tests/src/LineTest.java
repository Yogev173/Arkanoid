public class LineTest {
    ...
    /* intersection */
    //3-46
    private static void intersectionTest(Tester tester) {
        System.out.println("\ntesting the intersection method:");
        //3-16
        notParallelLineTest(tester);
        //19-26
        parallelNotInfinityInclineTest(tester);
        //27-46
        parallelInfinityInclineTest(tester);
    }

    //3-16
    private static void notParallelLineTest(Tester tester) {
    ...
    //19-24
    private static void parallelNotInfinityInclineTest(Tester tester){
    ...
    //27-46
    private static void  parallelInfinityInclineTest(Tester tester) {
    ...
    /* middle */
    //47-49
    private static void middleTest(Tester tester) {
    ...
    /* length */
    //50-51
    private static void lengthTest(Tester tester) {
